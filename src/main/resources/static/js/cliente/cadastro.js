document.addEventListener('DOMContentLoaded', () => {
    ...
    btnAdicionarEndereco.addEventListener('click', function () {
        ...
        endereco.querySelector('.btn-remover-endereco').style.display = 'block';
    ...
    btnAdicionarCartao.addEventListener('click', function () {
        ...
        cartao.querySelector('.btn-remover-cartao').style.display = 'block';
    ...
    confirmarSenha.addEventListener('input', function () {
        validarConfirmacaoSenha(senha, confirmarSenha, erroConfirmarSenha);
    });
    ...
    function configurarPreferencial(cartao) {
        ...
        radio.addEventListener('change', function () {
            document.querySelectorAll('.cartao-item input[type="radio"]').forEach(function (outroRadio) {
                    if (outroRadio !== radio) {
